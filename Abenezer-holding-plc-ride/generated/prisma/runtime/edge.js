...
var Ci = Fe((Ke) => {
  ...
  function ka(e) {
    ...
    if (e.length !== void 0)
      return typeof e.length != 'number' || dn(e.length) ? xe(0) : un(e);
...
C.inverseTangent = C.atan = function () {
  ...
  if (d.isFinite()) {
    ...
    if (d.abs().eq(1) && h + 4 <= An)
      return ((s = ge(g, h + 4, v).times(0.25)), (s.s = d.s), s);
  } else {
...
function bo(e) {
  ...
  function i(o) {
    ...
    if (l === 'bigint')
      return (o < 0 ? ((o = -o), (d.s = -1)) : (d.s = 1), wr(d, o.toString()));
    throw Error(Ie + o);
  }
  if (
    ((i.prototype = C),
