  ...
  we = (e, r, t) => {
    ...
    if (ai(e)) {
      ...
      return Reflect.ownKeys(e).every((n) => {
        let i = e[n];
        return (
          (n in r || (Gt((o = i)) && o[De]().matcherType === 'optional')) &&
          we(i, r[n], t)
        );
        var o;
      });
...
var Be = (e) =>
  ...
  Ee = (e) =>
    Object.assign(pe(e), {
      between: (r, t) =>
        Ee(q(e, ((n, i) => C((o) => be(o) && n <= o && i >= o))(r, t))),
...
m.precision = m.sd = function (e) {
  ...
  return (
    t.d ? ((r = Gs(t.d)), e && t.e + 1 > r && (r = t.e + 1)) : (r = NaN),
    r
  );
};
m.round = function () {
...
async function yl(e, r) {
  ...
  if (
    (Xm('enginePath', n), n !== void 0 && e === 'binary' && Pi(n), n !== void 0)
  )
